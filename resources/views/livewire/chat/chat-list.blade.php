            ...
            @if($conversations)
                ...
                @foreach($conversations as $key=> $conversation)
                    ...
                    <li
                        ...
                        class="py-3 hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-780/70 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 {{$conversation->id==$selectedConversation?->id ? 'bg-gray-200':''}}">
                        <a href="#" class="shrink-0">
                            <x-avatar src="https://picsum.photos/800/600?random={{ $key }}"
                            ...
                            <a href="{{route('chat',$conversation->id)}}"
                               class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                                ...
                                <div class="flex justify-between w-full items-center">
                                    ...
                                    <small
                                        class="text-gray-700">{{$conversation->messages?->last()?->created_at->diffForHumans()}}</small>
